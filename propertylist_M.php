            ...
            <div class="content-container col-md-8">
                ...
                <div class="row no-gutters">
                    ...
                    <div class="button-container col-6">
                        <a href="propertydetail_M2.html" class="btn btn-primary">View</a>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="property-card row">
            ...
            <div class="content-container col-md-8">
                ...
                <div class="row no-gutters">
                    ...
                    <div class="button-container col-6">
                        <a href="propertydetail_M1.html" class="btn btn-primary">View</a>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="property-card row">
            ...
            <div class="content-container col-md-8">
                ...
                <div class="row no-gutters">
                    ...
                    <div class="button-container col-6">
                        <a href="propertydetail_M3.html" class="btn btn-primary">View</a>
                    </div>
                </div>
            </div>
        </div>
