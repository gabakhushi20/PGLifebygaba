...
<body>
    ...
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb py-2">
            ...
            <li class="breadcrumb-item">
                <a href="propertylist_B.html">Bengaluru</a>
            </li>
    ...
    <div id="property-images" class="carousel slide" data-ride="carousel">
        ...
        <div class="carousel-inner">
            <div class="carousel-item active">
                <img class="d-block w-100" src="https://images.jdmagicbox.com/comp/bangalore/s7/080pxx80.xx80.180427122438.w9s7/catalogue/brahmini-ladies-pg-chikbanavara-bangalore-paying-guest-accommodations-for-men-herl24g4vm.jpg?clr=4f3317" alt="slide">
            </div>
            <div class="carousel-item">
                <img class="d-block w-100" src="img/46ebbb537aa9fb0a.jpg" alt="slide">
            </div>
            <div class="carousel-item">
                <img class="d-block w-100" src="img/eace7b9114fd6046.jpg" alt="slide">
            </div>
        </div>
    ...
    <div class="property-summary page-container">
        ...
        <div class="detail-container">
            ...
            <div class="property-gender">
                <img src="C:/xamppp/htdocs/PGLife/img/unisex.png" />
            </div>
        </div>
    ...
    <script type="text/javascript" src="C:/xamppp/htdocs/PGLife/js/jquery.js"></script>
    <script type="text/javascript" src="C:/xamppp/htdocs/PGLife/js/bootstrap.min.js"></script>
